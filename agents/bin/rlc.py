...
class RLC(Agent):
    ...
    def start_training_time_step(self, start_training_time_step: int):
        # self.__start_training_time_step = 500 if start_training_time_step is None else start_training_time_step
        self.__start_training_time_step = 8800 if start_training_time_step is None else start_training_time_step

    @end_exploration_time_step.setter
    def end_exploration_time_step(self, end_exploration_time_step: int):
        # self.__end_exploration_time_step = 500 if end_exploration_time_step is None else end_exploration_time_step
        self.__end_exploration_time_step = 8800 if end_exploration_time_step is None else end_exploration_time_step
